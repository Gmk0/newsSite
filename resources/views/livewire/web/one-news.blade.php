<div class="min-h-screen">
    ...
    <div class="py-6 px-4 bg-gray-50">
        <div class="px-6 mx-auto xl:container sm:px-4 xl:px-2">
            <div class="flex relative flex-row flex-wrap">
                <!-- Left -->
                <div class="flex-shrink w-full max-w-full overflow-hidden lg:w-2/3">
                    <div class="w-full py-3 mb-3">
                        <h2 class="text-3xl font-bold text-gray-800">
                            <span class="inline-block h-5 mr-2 border-l-[4px] border-red-600"></span>
                            {{$post->title}}
                        </h2>
                    </div>
                    <div class="flex flex-row flex-wrap -mx-3">
                        <div class="w-full max-w-full px-4">
                            ...
                            <div class="pb-4 leading-relaxed">
                                ...
                                <div class="justify-center prose text-justify">
                                ...
                                <div
                                    class="relative flex flex-row items-center justify-between px-6 py-2 mt-12 mb-2 overflow-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20">
                                    <div class="my-4 text-sm">
                                        <!--author-->
                                        <span class="mr-2 md:mr-4">
                                            <!-- <i class="fas fa-user me-2"></i> -->
                                            <svg class="inline-block mr-2 bi bi-person" width="1rem" height="1rem"
                                                viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M13 14s1 0 1-1-1-4-6-4-6 3-6 4 1 1 1 1h10zm-9.995-.944v-.002.002zM3.022 13h9.956a.274.274 0 00.014-.002l.008-.002c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664a1.05 1.05 0 00.022.004zm9.974.056v-.002.002zM8 7a2 2 0 100-4 2 2 0 000 4zm3-2a3 3 0 11-6 0 3 3 0 016 0z"
                                                    clip-rule="evenodd"></path>
                                            </svg> by <a class="font-semibold" href="#">{{$post->author}}</a>
                                        </span>
                                        <!--date-->
                                        <time class="mr-2 md:mr-4">
                                            <!-- <i class="fas fa-calendar me-2"></i> -->
                                            <svg class="inline-block mr-2 bi bi-calendar" width="1rem" height="1rem"
                                                viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                ...
                                                <path fill-rule="evenodd"
                                                    ...
                                                    clip-rule="evenodd"></path>
                                            </svg> {{$post->published_at}}
                                        </time>
                                        <!--view-->
                                        <span class="mr-2 md:mr-4">
                                            <!-- <i class="fas fa-eye me-2"></i> -->
                                            <svg class="inline-block mr-2 bi bi-eye" width="1rem" height="1rem"
                                                viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                            ...
                            <!-- author -->
                            <div class=" hidden flex-row flex-wrap justify-center py-4 -mx-4">
                                <div class="flex-shrink w-1/3 max-w-full px-4 sm:w-1/4 md:w-1/6">
                                    <a href="#"><img class="h-auto max-w-full border rounded-full dark:border-gray-700"
                                            src="src/img/dummy/avatar.jpg" alt="author"></a>
                                </div>
                                <div class="flex-shrink w-2/3 max-w-full px-4 sm:w-3/4 md:w-10/12">
                                    <!--name-->
                                    <p class="mb-2 text-lg font-semibold leading-normal text-gray-800 dark:text-gray-100">
                            ...
                            <div id="comments" class="pt-16">
                                <!--title-->
                                <h3 class="mb-2 text-2xl font-semibold leading-normal text-gray-800 dark:text-gray-100">
                                    {{count($comments)}}
                                    Commentaires</h3>

                                <!--comment list-->
                                <ol class="mb-4">
                                    <li class="py-2 hidden mt-6">
                                        <div class="pb-4 border-b border-gray-200 border-dashed dark:border-gray-600">
                                            <footer>
                                    ...
                                    <li class="p-2 bg-gray-100 rounded-md mt-6">
                                        <div class="pb-4 border-b  border-gray-200 border-dashed dark:border-gray-600">
                                            <footer>
                                                <img class="float-left rounded-full w-20 h-20 max-w-full mr-4 border border-gray-200 dark:border-gray-700"
                                                    src="{{$comment->user->profile_photo_url}}" alt="avatar">
                                                <div>
                                                    <a class="mb-2 text-lg font-semibold leading-normal text-gray-800 dark:text-gray-100" href="#"
                                                        target="_blank">{{$comment->user->name}}</a>
                                                    <span class="text-sm md:float-right">
                                                        <time datetime="2020-10-27">{{$comment->created_at->format('d/M/Y')}}</time>
                                                    </span>
                                                </div>
                                            </footer>
                                            <div>
                                        ...
                                        <ul class="ml-12 hidden md:ml-24">
                                            <li class="py-2 mt-6">
                                                <div class="pb-4 border-b border-gray-200 border-dashed dark:border-gray-600">
                                                    <footer>
                                                        <img class="float-left w-16 h-16 max-w-full mr-4 border border-gray-200 dark:border-gray-700"
                                                            src="src/img/avatar2.jpg" alt="avatar">
                                                        <div>
                                                            <a class="mb-2 text-lg font-semibold leading-normal text-gray-800 dark:text-gray-100" href="#"
                                                                target="_blank">Carlos vila</a>
                                                            <span class="text-sm md:float-right">
                                                                <time datetime="2020-10-27">Oct 27, 2020</time>
                                                            </span>
                                                        </div>
                                ...
                                <div id="comment-form" class="mt-12">
                                    <h4 class="mb-2 text-2xl font-semibold leading-normal text-gray-800 dark:text-gray-100">
                                        LAISSER UN COMMENTAIRE</h4>
                                    <p class="mb-5">
                                    Votre adresse e-mail ne sera pas publiée</p>
                                    <div>
                                        <form wire:submit.prevent='comment'>
                                          ...
                                          <div class="mb-6">
                                                <input wire:model='form.email'
                                                    class="relative w-full px-5 py-3 overflow-x-auto leading-5 text-gray-800 bg-white border border-gray-100 focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                                    placeholder="Email" aria-label="email" type="text" required="">
                                            </div>
                                            <div class="mb-6">
                                                <input
                                                    class="relative hidden w-full px-5 py-3 overflow-x-auto leading-5 text-gray-800 bg-white border border-gray-100 focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            ...
                                            <div class="mb-6">
                                                <div>
                                                    ...
                                                    <label class="ml-2" for="comment-cookies">
                                                        Enregistrer mon nom, mon adresse e-mail et mon site web dans ce navigateur pour la prochaine fois que je commenterai.
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="mb-6">
                                                ...
                                                <a href="{{route('login')}}">
                                                <button type="button"
                                                    class="flex items-center px-5 py-3 leading-5 text-gray-100 bg-black hover:text-white hover:bg-gray-900 hover:ring-0 focus:outline-none focus:ring-0">
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="post-number">
                                        <li class="border-b border-gray-100 hover:bg-gray-50">
                                            <a class="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Why the world would end
                                                without political polls</a>
                                        </li>
                                        <li class="border-b border-gray-100 hover:bg-gray-50">
                                            <a class="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Meet The Man Who Designed
                                                The Ducati Monster</a>
                                        </li>
                                        <li class="border-b border-gray-100 hover:bg-gray-50">
                                            <a class="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">2020 Audi R8 Spyder spy
                                                shots release</a>
                                        </li>
                                        <li class="border-b border-gray-100 hover:bg-gray-50">
                                            <a class="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Lamborghini makes Huracán
