                ...
                <div class="flex flex-row flex-wrap -mx-3 lg:justify-between">
                    <div class="flex-shrink w-full max-w-full px-3 lg:w-2/5 lg:pr-16">
                        <div class="flex items-center mb-2">
                            <span class="mt-2 mb-2 text-3xl font-bold leading-normal text-gray-100">TailNews</span>
                    ...
                    <div class="flex-shrink w-full max-w-full px-3 lg:w-3/5">
                        <div class="flex flex-row flex-wrap">
                            <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/4 lg:mb-0">
                                <h4 class="mb-3 text-base leading-normal text-gray-100 uppercase">Product</h4>
                                <ul>
                            ...
                            <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/4 lg:mb-0">
                                <h4 class="mb-3 text-base leading-normal text-gray-100 uppercase">Support</h4>
                                <ul>
                            ...
                            <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/4 lg:mb-0">
                                <h4 class="mb-3 text-base leading-normal text-gray-100 uppercase">Includes</h4>
                                <ul>
                            ...
                            <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/4 lg:mb-0">
                                <h4 class="mb-3 text-base leading-normal text-gray-100 uppercase">Legal</h4>
                                <ul>
            ...
            <div class="container py-4 border-t border-gray-200 border-opacity-10">
                <div class="row">
                    <div class="text-center col-12 col-md">
                        <p class="my-3 d-block">Copyright © Your Company | All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
