<div class="min-h-screen lg:px-6 bg-gray-50">
    ...
    <div class="py-6 bg-gray-50">
        <div class="px-6 mx-auto xl:container xl:px-2">
            <div class="flex flex-row flex-wrap">
                <!-- Left -->
                <div class="flex-shrink w-full max-w-full overflow-hidden lg:w-2/3">
                    <div class="w-full py-3">
                        <h2 class="text-2xl font-bold text-gray-800">
                            <span class="inline-block h-5 mr-2 border-red-600 border-l-3"></span>Europe
                        </h2>
                    </div>
                    <div class="flex flex-row flex-wrap -mx-3">
                        <div class="flex-shrink w-full max-w-full px-3 pb-5">
                            <div class="relative overflow-hidden hover-img max-h-98">
                                <!--thumbnail-->
                                <a href="#">
                                    <img class="w-full h-auto max-w-full mx-auto" src="/images/1.jpg"
                                ...
                                <div class="absolute bottom-0 w-full px-5 pt-8 pb-5 bg-gradient-cover">
                                    ...
                                    <p class="hidden text-gray-100 sm:inline-block">Russia says a fire on its flagship
                                        vessel in the Black Sea detonated munitions - Ukraine says it fired missiles at the
                                        Moskva</p>
                                    <!-- author and date -->
                                    <div class="pt-2">
                        ...
                        <div
                            class="flex-shrink w-full max-w-full px-3 pt-3 pb-3 border-b-2 border-gray-100 border-dotted lg:w-1/3 sm:pt-0 sm:border-b-0">
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="w-full max-w-full mx-auto" src="/images/3.jpg" alt="alt title">
                                </a>
                                <div class="py-0 pl-3 sm:py-3 sm:pl-0">
                                    ...
                                    <p class="hidden mb-1 leading-tight text-gray-600 md:block">This is a wider card with
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="w-full max-w-full mx-auto" src="/images/1.jpg" alt="alt title">
                                </a>
                                <div class="py-0 pl-3 sm:py-3 sm:pl-0">
                                    <h3 class="mb-2 text-lg font-bold leading-tight">
                                        <a href="#">5 Tips to Save Money Booking Your Next Hotel Room</a>
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="w-full max-w-full mx-auto" src="src/img/dummy/img16.jpg" alt="alt title">
                                </a>
                                <div class="py-0 pl-3 sm:py-3 sm:pl-0">
                                    <h3 class="mb-2 text-lg font-bold leading-tight">
                                        <a href="#">5 Tips to Save Money Booking Your Next Hotel Room</a>
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="w-full max-w-full mx-auto" src="src/img/dummy/img17.jpg" alt="alt title">
                                </a>
                                <div class="py-0 pl-3 sm:py-3 sm:pl-0">
                                    <h3 class="mb-2 text-lg font-bold leading-tight">
                                        <a href="#">5 Tips to Save Money Booking Your Next Hotel Room</a>
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="w-full max-w-full mx-auto" src="src/img/dummy/img18.jpg" alt="alt title">
                                </a>
                                <div class="py-0 pl-3 sm:py-3 sm:pl-0">
                                    <h3 class="mb-2 text-lg font-bold leading-tight">
                                        <a href="#">5 Tips to Save Money Booking Your Next Hotel Room</a>
